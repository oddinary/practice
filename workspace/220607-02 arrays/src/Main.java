public class Main {
	public static void main(String[] args) {
		...
		aBox = new int[4]; // 배열의 길이를 4로 초기화. new를 썻으니까 새로운 인스턴스가 생성, 그리고 참조변수 aBox가 길이가 4인 배열을 참조한다
		System.out.println("배열의 길이값 : " + aBox.length);
		
//		aBox.length = 10;(x) 자바의 배열은 초기화시에 정해둔 길이값을 변경할 수 없다.(final하게 상수로 설정되어있음)
