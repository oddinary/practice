...
public class Main4 {
	public static void main(String[] args) {
		...
		StringTokenizer stf = new StringTokenizer(friday, "금");
		StringTokenizer sty = new StringTokenizer(friday, "요");
		StringTokenizer st3 = new StringTokenizer(friday, "일");
		StringTokenizer stc = new StringTokenizer(friday, "시");
		...
		int x = 0, y = 0;
		for (int i = 0; i < stf.countTokens(); i++)
