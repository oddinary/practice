...
public class Main {
	public static void main(String[] args) {
		...
		animal[0] = new Animal("코끼리", 3, 300, "초식");
		animal[1] = new Animal("토끼", 1, 3, "초식");
		animal[2] = new Animal("사자", 3, 150, "육식");
		animal[3] = new Animal("늑대", 3, 40, "육식");
		Staff[] staff = new Staff[5];
		staff[0] = new Staff("aaa", 27, "조련사");
		staff[1] = new Staff("bbb", 32, "경영");
		staff[2] = new Staff("ccc", 29, "조련사");
		staff[3] = new Staff("ddd", 30, "조련사");
		staff[4] = new Staff("eee", 31, "경영");
